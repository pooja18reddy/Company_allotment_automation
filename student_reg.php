...
CGPA :<input type="text" name="cgpa" required>
E-mail :<input type="email" name="email" required></br>
Phone :<input type="tel" name="phone_1" required></br>
Emergency Contact Person:<input type="text" name="name1" required></br>
Relation(with emergency contact person):<input type="text" name="rel" required></br>
Emergency Phone :<input type="tel" name="phone_2" required></br>
