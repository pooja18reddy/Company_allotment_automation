...
<label>Consent given by :</label><input type="text" name="cgb" required>
<label>Consent obtained by:</label><input type="text" name="cob" required>
...
<label>Number of girls:</label><input type="text" name="no_of_girls" >
<label>Number of boys:</label><input type="text" name="no_of_boys" >
<label>CGPA(if specified):</label><input type="text" name="cgpa">
<label>Nature of work:</label><input type="text" name="now">
<label>Weekly Holidays:</label><input type="text" name="wh">
