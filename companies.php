...
<?php
 ...
 //Selecting Database
 $sql = "Select company_id,company_name from company_requirements";
 ...
 if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
		 ?>
						   ...
						   <td><?php echo "select branch,cgpa,nature_of_work,working_hrs,weekly_holidays,phone,email,wesite,address from company_requirements"; ?></td> 
