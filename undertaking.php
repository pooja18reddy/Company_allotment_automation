  ...
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      <li class="active"><a href="undertaking.php">Undertaking</a></li>
              <li class ="button"><a href="preference.php">Preference</a></li>
 ...
 if(!empty($_POST['ID']))
{
 ...
 if($numrows == 0)
  {
	  $sql = "INSERT IGNORE INTO eligibility(student_id,undertaking) VALUES('$id','given')";
...
{
    $sql = "UPDATE eligibility SET undertaking='given' WHERE student_id='$id'";
    if (mysqli_query($conn, $sql)) {
